#!/usr/bin/env python3
"""
Auto-Detect AI Edge Converter for LLM models to LiteRT format.

This script auto-detects model architecture from config.json and uses
the appropriate ai-edge-torch model builder for conversion.
"""
